...
function listarFornecedor($conexao)
{
    ...
    $resultado = mysqli_query($conexao, "select * from fornecedor order by razao_social");
...
$listacli = listarFornecedor($conexao);
?>
    ...
    <div class="container-fluid">
        <div class="row mt-5">
            ...
            <div class="col-md-7 p-5">
                ...
                <hr class="mb-5">
                <form method="post" action="cad_entrada.php" style="margin-left: 70px;">
                    <!-- Ele envia os dados para tela de cadastro-->
                    <div class="form-row">
                        <div class="form-group col-md-10 mb-3">
                            <label for="exampleInputUsuario">Fornecedor</label>
                            <select style="font-size:18px" class="form-control" name="txtrazao_social">
                                <?php foreach ($listacli as $cli) { ?>
                                    <option value="<?php echo $cli['id'] ?>"><?php echo $cli['razao_social'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn mt-5 text-center" style="background-color: #32CD32; color:white; border-radius: 25px;" value="Iniciar Venda"> <i class="fas fa-dollar-sign"></i> Iniciar  </button>
                    </div>
                </form>
            </div>
        </div>
