...
$consulta = " SELECT produto.descricao_produto, itens_venda.qnt, itens_venda.preco FROM itens_venda, produto where itens_venda.id_venda = $id_venda and produto.id = itens_venda.id_produto";
$con = @mysqli_query($conexao, $consulta) or die($mysqli->error);

//fazendo select para exibição do total da venda
$preco = "SELECT sum(preco * qnt) as total FROM itens_venda where id_venda = $id_venda";
        ...
        <div class="row m-5">
            <div class="col-md-12 mt-4">
                ...
                <div class=" text-center mt-5 mb-2 mr-2">
                    <h2 class="ml-2" style="color: #32CD32;"> <i class="fas fa-shopping-cart"></i> Consulte seu Carrinho </h2>
                </div>
                <!--Fim dos botões-->
                <div class="d-flex justify-content-between mt-5 mb-2 mr-2">
                    <div class="form-row col-md-6">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control" name="txttotal" value='<?php echo number_format($total['total'], 2); ?>' readonly>
                        </div>
                    </div>
